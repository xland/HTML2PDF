...
class DocumentContainer : public document_container
{
public:
	DocumentContainer();
	...
	virtual pixel_t				text_width(const char* text, litehtml::uint_ptr hFont);
	...
	virtual pixel_t				pt_to_px(float pt) const;
	virtual pixel_t				get_default_font_size() const;
	...
	virtual void				draw_solid_fill(litehtml::uint_ptr hdc, const background_layer& layer, const web_color& color);
	virtual void				draw_linear_gradient(litehtml::uint_ptr hdc, const background_layer& layer, const background_layer::linear_gradient& gradient);
	virtual void				draw_radial_gradient(litehtml::uint_ptr hdc, const background_layer& layer, const background_layer::radial_gradient& gradient);
	virtual void				draw_conic_gradient(litehtml::uint_ptr hdc, const background_layer& layer, const background_layer::conic_gradient& gradient);
